...
public class LCHttpUrlConnection {
	 ...
	 */
    public static HttpURLConnection getHttpConnection(String path, String
     ...
     */
    public static HttpURLConnection getHttpConnectionWithHeader(Context
																		context, String params, String url) throws
																											MalformedURLException,
																											IOException {
    	return RequestHeader.constructHeader(context,params,url);
    }
