...
public class AuthenticationActivity extends BaseActivity implements View.OnClickListener, IUploadImage{

    private ImageView mIvCardFront;
    private ImageView mIvCardBack;
    private ImageView mIvCardWithPeople;
    ...
    private int type_back = ++S_TYPE;
    private int type_people = ++S_TYPE;

    private String CARDFRONT = "cardFront";
    private String CARDBACK = "cardBack";
    private String CARDFRONTPEOPLE = "cardFrontWithPeople";
    ...
    @Override protected void initView() {
        ...
        mIvCardBack = (ImageView) findViewById(R.id.iv_back);
        ...
        EasyImage.handleActivityResult(requestCode, resultCode, data, this, new DefaultCallback() {
            ...
            public void onCanceled(EasyImage.ImageSource source, int type) {
                ...
                if (source == EasyImage.ImageSource.CAMERA) {
                    File photoFile = EasyImage.lastlyTakenButCanceledPhoto(AuthenticationActivity.this);
    ...
    private void onPhotoReturned(File imgFile, int type){
        ...
        if(type == type_front) {
            ...
            Glide.with(this)
                 ...
                 .into(mIvCardBack);
            typeInfo = CARDBACK;
        }else if(type == type_people){
            Glide.with(this)
                 .load(imgFile)
                 .centerCrop()
                 .into(mIvCardWithPeople);
            typeInfo = CARDFRONTPEOPLE;
        }
        mFileMapDatas.put(typeInfo, imgFile);
        updateBtnState();
    }

    private void updateBtnState(){
        if(mFileMapDatas.size() == 2){
    ...
    @Override public void finish() {
        ...
        if(mFileMapDatas.size() == 2 && StringUtil.checkStr(mResult)){
            resultData.putExtra(ParamKeys.USER_AUTHENTICATION_STATE, ParamKeys.JS_SUCCESS);
            resultData.putExtra(ParamKeys.UPLOAD_IMG_RESULT, mResult);
        }else {
            resultData.putExtra(ParamKeys.USER_AUTHENTICATION_STATE, ParamKeys.JS_FAILURE);
        }
