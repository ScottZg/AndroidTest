...
import com.shuqu.microcredit.Interface.IUpdateProgress;
...
public class UpdateService extends Service {
    ...
    public static final String ACTION = "me.lyndon.UPDATE_APP";
    ...
    private IUpdateProgress updateProgressListener;
    ...
    public class LocalBinder extends Binder {
         ...
         * @param listener
         */
        public void setUpdateProgressListener(IUpdateProgress listener){
    ...
    public void setUpdateProgressListener(IUpdateProgress updateProgressListener) {
