package com.shuqu.microcredit.widget.stickylistheaders;
...
class AdapterWrapper extends BaseAdapter implements StickyListHeadersAdapter {
	...
	private DataSetObserver mDataSetObserver = new DataSetObserver() {
		...
		public void onInvalidated() {
			mHeaderCache.clear();
			com.shuqu.microcredit.widget.stickylistheaders.AdapterWrapper.super.notifyDataSetInvalidated();
		}

		@Override
		public void onChanged() {
			com.shuqu.microcredit.widget.stickylistheaders.AdapterWrapper.super.notifyDataSetChanged();
		}
	};
