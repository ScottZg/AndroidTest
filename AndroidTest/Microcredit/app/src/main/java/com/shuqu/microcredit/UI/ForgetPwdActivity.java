...
public class ForgetPwdActivity extends BaseActivity implements View.OnClickListener {
    ...
    @Override protected void initView() {
        ...
        //        etNewPwdConfirm = (EditText) findViewById(R.id.et_confirm_pwd);
        tvGetCode = (TextView) findViewById(R.id.tv_get_code);
        imgShowPwd = (ImageView) findViewById(R.id.img_pwd_show);
        //        imgShowPwdConfrim = (ImageView) findViewById(R.id.img_confirm_pwd_show);
        ...
        //        flCheckBox = (FrameLayout) findViewById(R.id.fl_checkbox);
        ...
        //        flCheckBox.setOnClickListener(this);
    ...
    class CodeAysncTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            String requestData = "";
            requestData = NetUtil.requestData(ForgetPwdActivity.this, "POST", "", codeParams, false, Urls.getUrl(Urls.METHOD_GET_CODE_URL));
            return requestData;
        }
    ...
    class ForgetPwdAysncTask extends AsyncTask<Void, Integer, LoginRegistResult> {
        ...
        protected LoginRegistResult doInBackground(Void... params) {
            ...
            String requestData = "";
            requestData = NetUtil.requestData(ForgetPwdActivity.this, "POST", "", forgetParams, Urls.getUrl(Urls.METHOD_FORGET_PWD));
