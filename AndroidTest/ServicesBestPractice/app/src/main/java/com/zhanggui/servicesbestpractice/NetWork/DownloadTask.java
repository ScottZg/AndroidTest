...
public class DownloadTask extends AsyncTask <String,Integer,Integer>{
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            ...
            long conetentLength = getContentLength(downloadUrl);

            if (conetentLength == 0) {
                return TYPE_FAILED;
            }else if(conetentLength == downloadedLength) {
                return TYPE_SUCCESS;
            }
            ...
            if (response != null) {
                ...
                savedFile.seek(downloadedLength);   //跳过已经下载字节
                ...
                while ((len = is.read(b)) != -1) {
                    if (isCanceled) {
                        ...
                        int progress = (int)((total+downloadedLength)*100/conetentLength);
